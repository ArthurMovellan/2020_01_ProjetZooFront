...
@Component({
  selector: 'app-manager-list-animal',
  templateUrl: './manager-list-animal.component.html',
  styleUrls: ['./manager-list-animal.component.css']
})
export class ManagerListAnimalComponent implements OnInit {
  ...
  constructor(private animalService: AnimalService, private enclosService :EnclosService, private authentificationService : AuthentificationService, private formBuilder: FormBuilder) { }
