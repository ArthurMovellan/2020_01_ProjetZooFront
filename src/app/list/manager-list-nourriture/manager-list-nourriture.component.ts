...
@Component({
  selector: 'app-manager-list-nourriture',
  templateUrl: './manager-list-nourriture.component.html',
  styleUrls: ['./manager-list-nourriture.component.css']
})
export class ManagerListNourritureComponent implements OnInit {
