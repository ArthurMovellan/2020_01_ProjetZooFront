...
@Component({
  selector: 'app-personnel-update-tache',
  templateUrl: './personnel-update-tache.component.html',
  styleUrls: ['./personnel-update-tache.component.css']
})
export class PersonnelUpdateTacheComponent implements OnInit {
