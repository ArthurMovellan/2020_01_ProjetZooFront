...
export class UpdateAnimalComponent implements OnInit {
  ...
  constructor(private animalService: AnimalService, private enclosService: EnclosService, private nourritureService :NourritureService, private route: ActivatedRoute, private formBuilder: FormBuilder) { }
  ...
  redirection() {
    window.location.href = "/admin/listanimal";
  }
