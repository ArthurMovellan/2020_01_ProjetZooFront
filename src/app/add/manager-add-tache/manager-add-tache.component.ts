...
@Component({
  selector: 'app-manager-add-tache',
  templateUrl: './manager-add-tache.component.html',
  styleUrls: ['./manager-add-tache.component.css']
})

export class ManagerAddTacheComponent implements OnInit {
