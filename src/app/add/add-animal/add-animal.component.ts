...
export class AddAnimalComponent implements OnInit {
  ...
  constructor(private animalService: AnimalService, private enclosService: EnclosService, private nourritureService : NourritureService, private formBuilder: FormBuilder) { }
