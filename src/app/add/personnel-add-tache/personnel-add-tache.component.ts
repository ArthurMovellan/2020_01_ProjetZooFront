...
@Component({
  selector: 'app-personnel-add-tache',
  templateUrl: './personnel-add-tache.component.html',
  styleUrls: ['./personnel-add-tache.component.css']
})

export class PersonnelAddTacheComponent implements OnInit {
  ...
  ajoutTache() {
    ...
    this.nouveauTache.personne = this.connected;
  ...
  redirection() {
    window.location.href = "/personnel/listtache";
  }
